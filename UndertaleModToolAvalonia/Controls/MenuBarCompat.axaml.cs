...
public partial class MenuBarCompat : UserControl
{
    ...
    private static NativeMenu BuildMenu(MainViewModel vm)
    {
        ...
        NativeMenu importMenu = new();
        importMenu.Items.Add(Item("Menu_Import_Graphics", command: new RelayCommand(vm.ImportGraphics)));
        importMenu.Items.Add(Item("Menu_Import_GraphicsAdvanced", command: new RelayCommand(vm.ImportGraphicsAdvanced)));
        importMenu.Items.Add(Item("Menu_Import_ApplyBasicGraphicsMod", command: new RelayCommand(vm.ImportApplyBasicGraphicsMod)));
        importMenu.Items.Add(new NativeMenuItemSeparator());
        importMenu.Items.Add(Item("Menu_Import_AllEmbeddedTextures", command: new RelayCommand(vm.ImportAllEmbeddedTextures)));
        importMenu.Items.Add(Item("Menu_Import_AllTilesets", command: new RelayCommand(vm.ImportAllTilesets)));
        importMenu.Items.Add(new NativeMenuItemSeparator());
        importMenu.Items.Add(Item("Menu_Import_AllStrings", command: new RelayCommand(vm.ImportAllStrings)));
        importMenu.Items.Add(Item("Menu_Import_AllStringsJSON", command: new RelayCommand(vm.ImportAllStringsJSON)));
        importMenu.Items.Add(new NativeMenuItemSeparator());
        importMenu.Items.Add(Item("Menu_Import_Fonts", command: new RelayCommand(vm.ImportFonts)));
        importMenu.Items.Add(Item("Menu_Import_GMS2FontData", command: new RelayCommand(vm.ImportGMS2FontData)));
        importMenu.Items.Add(new NativeMenuItemSeparator());
        importMenu.Items.Add(Item("Menu_Import_GML", command: new RelayCommand(vm.ImportGML)));
        importMenu.Items.Add(Item("Menu_Import_Assembly", command: new RelayCommand(vm.ImportAssembly)));
        importMenu.Items.Add(new NativeMenuItemSeparator());
        importMenu.Items.Add(Item("Menu_Import_Masks", command: new RelayCommand(vm.ImportMasks)));
        importMenu.Items.Add(new NativeMenuItemSeparator());
        importMenu.Items.Add(Item("Menu_Import_Shaders", command: new RelayCommand(vm.ImportShaders)));
        importMenu.Items.Add(new NativeMenuItemSeparator());
        importMenu.Items.Add(Item("Menu_Import_Sounds", command: new RelayCommand(vm.ImportSounds)));
        importMenu.Items.Add(Item("Menu_Import_SingleSound", command: new RelayCommand(vm.ImportSingleSound)));
        importMenu.Items.Add(new NativeMenuItemSeparator());
        importMenu.Items.Add(Item("Menu_Import_NewTextureRepacker", command: new RelayCommand(vm.NewTextureRepacker)));
        importMenu.Items.Add(Item("Menu_Import_ReduceEmbeddedTexturePages", command: new RelayCommand(vm.ReduceEmbeddedTexturePages)));

        NativeMenu exportMenu = new();
        exportMenu.Items.Add(Item("Menu_Export_AllSprites", command: new RelayCommand(vm.ExportAllSprites)));
        exportMenu.Items.Add(Item("Menu_Export_SpecificSprites", command: new RelayCommand(vm.ExportSpecificSprites)));
        exportMenu.Items.Add(Item("Menu_Export_SpritesAsGIF", command: new RelayCommand(vm.ExportSpritesAsGIF)));
        exportMenu.Items.Add(new NativeMenuItemSeparator());
        exportMenu.Items.Add(Item("Menu_Export_AllTextures", command: new RelayCommand(vm.ExportAllTextures)));
        exportMenu.Items.Add(Item("Menu_Export_AllTexturesGrouped", command: new RelayCommand(vm.ExportAllTexturesGrouped)));
        exportMenu.Items.Add(Item("Menu_Export_AllTilesets", command: new RelayCommand(vm.ExportAllTilesets)));
        exportMenu.Items.Add(Item("Menu_Export_AllMasks", command: new RelayCommand(vm.ExportAllMasks)));
        exportMenu.Items.Add(Item("Menu_Export_AllEmbeddedTextures", command: new RelayCommand(vm.ExportAllEmbeddedTextures)));
        exportMenu.Items.Add(new NativeMenuItemSeparator());
        exportMenu.Items.Add(Item("Menu_Export_AllFonts", command: new RelayCommand(vm.ExportAllFonts)));
        exportMenu.Items.Add(new NativeMenuItemSeparator());
        exportMenu.Items.Add(Item("Menu_Export_AllShaders", command: new RelayCommand(vm.ExportAllShaders)));
        exportMenu.Items.Add(new NativeMenuItemSeparator());
        exportMenu.Items.Add(Item("Menu_Export_AllSounds", command: new RelayCommand(vm.ExportAllSounds)));
        exportMenu.Items.Add(new NativeMenuItemSeparator());
        exportMenu.Items.Add(Item("Menu_Export_AllStrings", command: new RelayCommand(vm.ExportAllStrings)));
        exportMenu.Items.Add(Item("Menu_Export_AllStringsJSON", command: new RelayCommand(vm.ExportAllStringsJSON)));
        exportMenu.Items.Add(new NativeMenuItemSeparator());
        exportMenu.Items.Add(Item("Menu_Export_AllCode", command: new RelayCommand(vm.ExportAllCode)));
        exportMenu.Items.Add(Item("Menu_Export_AllAssembly", command: new RelayCommand(vm.ExportAllAssembly)));
        exportMenu.Items.Add(Item("Menu_Export_SpecificCode", command: new RelayCommand(vm.ExportSpecificCode)));
        exportMenu.Items.Add(new NativeMenuItemSeparator());
        exportMenu.Items.Add(Item("Menu_Export_AllRoomsToPNG", command: new RelayCommand(vm.ExportAllRoomsToPNG)));
        exportMenu.Items.Add(Item("Menu_Export_TextureGroups", command: new RelayCommand(vm.ExportTextureGroups)));
