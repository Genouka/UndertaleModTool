...
public partial class FindReferencesViewModel : ObservableObject
{
    ...
    public async void FindReferences()
    {
        ...
        loaderWindow.SetText(LocalizationSource.GetString("FindRefs_Finding"));
    ...
    public class FindReferencesResult
    {
        ...
        public FindReferencesResult(UndertaleObject resource, string property)
        {
            ...
            {
                Name = namedResource.Name?.Content ?? LocalizationSource.GetString("FindRefs_Unknown");
            }
            else
            {
                Name = resource.ToString() ?? LocalizationSource.GetString("FindRefs_Unknown");
            }
            Property = property;
            Resource = resource;
        }
