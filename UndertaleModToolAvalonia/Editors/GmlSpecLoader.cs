...
/// <summary>
/// Loads the GML specification (functions, variables, constants and their descriptions)
/// from the bundled <c>GmlSpecEnglish.gmlspec</c> / <c>GmlSpecChinese.gmlspec</c> files.
/// </summary>
public static class GmlSpecLoader
{
        ...
        Dictionary<string, GmlSpecConstant> constants)
    {
        ...
        {
            filePath = Path.Combine(exeDir, "Resources", fileName);
        }
    ...
    {
        string lang = LocalizationSource.Instance.CurrentCulture.Name;
